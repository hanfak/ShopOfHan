...
public class StockIsAdded {
    ...
    public ActionUnderTest throughARequestTo(String productName, String uri, String productId, String stockId, String stockDescription, long amount) {
        ...
        return (interestingGivens, capturedInputAndOutputs) -> whenWeMakeARequestTo(capturedInputAndOutputs, buildRequest(uri, productName, productId, stockId, stockDescription, amount));
    }

    private Request buildRequest(String productName, String uri, String productId, String stockId, String stockDescription, long amount) {
        return new RequestBuilder()
                ...
                .body(format("{\"productName\" : \"%s\", " +
                        ...
                        "\"stockId\" : \"%s\", " +
                        "\"stockDescription\" : \"%s\", " +
                        "\"amounnt\" : %s}", productName, productId, stockId, stockDescription, amount))
                .build();
    }
